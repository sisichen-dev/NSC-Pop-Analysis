...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Plot coefficients comparison: SI Figure 9
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
set(gca,'Xtick', 1:3, 'XTickLabel', {'pre-astro','comm. neuron','pre-neuro'})
title('LS model')
xlabel('cell type')
set(gca,'FontSize',8);
...
xlabel('cell type')
set(gca,'FontSize',8);
set(gcf, 'Position',[440   525   500   250]);
print(['SI_model_coefficients_comparison.pdf'], '-dpdf','-r300')
